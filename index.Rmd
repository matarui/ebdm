...
| # | Date     | Topic                         | 
|---| ---------|-------------------------------|
| 1 | 20.02.2023 | [The scientific method(s)](session1.html) | 
| 2 | 06.03.2023 | [Algorithms: The power of algorithms](session2.html) | 
| 3 | 13.03.2023 | [Algorithms: The problems of algorithms](session3.html) | 
| 4 | 20.03.2023 | [Consensus: The wisdom of the crowd](session4.html) | 
| 5 | 27.03.2023 | [Consensus: The wisdom of experts](session5.html) | 
| 6 | 17.04.2023 | [Counterfactuals: Experiments](session6.html) | 
| 7 | 24.04.2023 | [Counterfactuals: Alternatives to experiments](session7.html) | 
| 8 | 08.05.2023 | [Synthesis](session8.html) | 
| 9 | 15.05.2023 | [Interventions](session9.html) | 
...
Each session is structured such that some materials are available for preparation before the session (i.e., youtube videos, recommended readings) and students are expected to have consulted those before each session. In addition, the slides of each presentation are made available to give students an idea of the session content. Note that the final version of the slides will typically be made available *after* each session. 
...
No video recordings of the sessions will be made available. 

...
| 9 | 15.05.2023 | [Interventions](session11.html) | 
...
Each session is structured such that some materials are available for preparation before the session (i.e., youtube videos, recommended readings) and students are expected to have consulted those before each session. In addition, the slides of each presentation are made available to give students an idea of the session content. Note that the final version of the slides will only be made available *after* each session. 

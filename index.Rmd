...
This website is designed to help course participants get an overview of the course and access most course materials. Each session is structured such that some materials are available for prepaartion before the session (recommended readings, video). 

The slides of each presentation are available. However, the final version of the slides will only be made available *after* each session. 

Finally, some additional resources, such as optional exercises or further readings are listed at the end of each session. 
